...
To identify the CSTV with this approach, we also implemented the classical Cate and Nelson (1965) method with the \texttt{soiltestcorr} package (Correndo et al, 2023). Relative yield was plotted against STP, and a 95\% RY cutoff was used to distinguish responsive from non-responsive observations. The algorithm searches for the CSTV that maximizes the number of correct classifications relative to this target. The resulting CSTV was marked by a vertical dashed line, and the 95\% RY threshold was shown as a horizontal reference.
