...
K-means provides sharp, interpretable category boundaries suitable for decision support, while FCM highlights transitional cases where fertility status is ambiguous. Archetype analysis, though designed to capture extreme soil P--yield relationships, nevertheless produced nearly identical soil P thresholds upon projection, reinforcing that P availability is the primary driver of structure in this dataset.

Across all three unsupervised learning approaches, the resulting soil P thresholds were remarkably stable, converging near 14 ppm and 25 ppm. These values align closely with the conceptual boundaries distinguishing low, medium, and adequate soil test categories in traditional calibration frameworks. Importantly, the thresholds emerged directly from the joint distribution of soil P and yield 
response rather than from predetermined probability classes, suggesting that the data themselves contain strong internal structure. The agreement among methods despite differing mathematical criteria strengthens confidence in these thresholds as agronomically meaningful fertility classes.
